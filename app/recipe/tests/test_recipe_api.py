...
def detail_url(recipe_id):
    """Create an return a recpie detail URL."""
...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test list of recipies for auth user"""
    ...
    def test_partial_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        # get new data from DB after update
    ...
    def test_create_recipe_with_new_tags(self):
        """test create recpie with new tags"""
        payload = {
        ...
        for tag in payload['tags']:
            exists = tags.filter(name=tag['name'], recipe=recipe).exists()
    ...
    def test_update_recipe_assign_tag(self):
        """Test assiging an existing tag when updating"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 10,
            'price': Decimal('3.50'),
            'ingredients': [{'name': 'Aguacate'}, {'name': 'Lemmon'}]
        }
        res = self.client.post(RECIPE_URL, payload, format='json')
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipe = Recipe.objects.get(id=res.data['id'])
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 5,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Lime'}, {'name': 'Sugar'}]
        }
        res = self.client.post(RECIPE_URL, payload, format='json')
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test assiging an existing ingredient when updating"""
    ...
    def test_filter_by_tags(self):
        ...
        tag2 = Tag.objects.create(user=self.user, name='Vegetarisn')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Posh and Beans')
